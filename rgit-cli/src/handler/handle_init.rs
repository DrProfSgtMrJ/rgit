...
fn create_head_file(rgit_dir_path: &PathBuf) -> Result<(), std::io::Error> {
...
fn create_config_file(rgit_dir_path: &PathBuf) -> Result<(), std::io::Error> {
...
fn create_description_file(
    ...
    description_file.write(description.as_bytes())?;
